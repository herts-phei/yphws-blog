...
```{r}
yphws_data_private <- readRDS("../../data/yphws_data_private.Rds")
...
<!--   dplyr::select(schyear, age, District, sex, drug_ever, worry_mental, imd_quintile, schyear, life_satisfied, condition_mental, skipschool_mentalhealth, mental_accessed, -->
...
<!--                 mental_accessed = as.factor(ifelse(mental_accessed == "Yes", "Yes", "No")), -->

<!--                 condition_mental = as.factor(ifelse(condition_mental == "Yes", "Yes", "No")), -->

<!--                 skipschool_mentalhealth = as.factor(ifelse(skipschool_mentalhealth == "Yes", "Yes", "No")) -->

<!--          ) %>%  -->

<!--   filter(drug_yes_no == "yes", -->

<!--          schyear != "Not at school/other") -->

<!-- model <- glm(data = model_data, skipschool_mentalhealth ~ drug_yes_no + sex + schyear  + imd_quintile, family = binomial) -->

<!-- model <- glm(data = model_data, skipschool_mentalhealth ~ sex + schyear  + imd_quintile, family = binomial) -->

<!-- ### Worry -->

<!-- model_worry <- glm(data = model_data, worry_mental ~   schyear + sex + imd_quintile, family = binomial) -->

<!-- model_worry <- glm(data = model_data, worry_mental ~   schyear + sex + imd_quintile, family = binomial) -->

<!-- summary(model_worry) -->

<!-- df <- as.data.frame(exp(coef(model_worry))) %>% -->

<!--   rename(Coefficient =  "exp(coef(model_worry))") %>% -->

<!--   mutate(sex = rownames(.)) %>% -->

<!--   left_join(mutate(as.data.frame(exp(confint(model_worry))), sex = row.names(.))) %>% -->
...
<!--   labs(title = "Worry having taken drugs ", -->

<!--        subtitle = "Baseline group: Females") -->
...
<!-- model_skip <- glm(data = model_data, skipschool_mentalhealth ~   schyear + sex + imd_quintile, family = binomial) -->

<!-- model_skip <- glm(data = model_data, skipschool_mentalhealth ~   schyear + sex + imd_quintile, family = binomial) -->

<!-- summary(model_skip) -->

<!-- df <- as.data.frame(exp(coef(model_skip))) %>% -->

<!--   rename(Coefficient =  "exp(coef(model_skip))") %>% -->

<!--   mutate(Group = rownames(.)) %>% -->

<!--   left_join(mutate(as.data.frame(exp(confint(model_skip))), Group = row.names(.))) %>% -->
...
<!-- ggplot(df, aes(x = Coefficient, y = Group)) + -->
...
<!--   labs(title = "Skip School having taken drugs ", -->
...
<!-- model_access <- glm(data = model_data, mental_accessed ~   schyear + sex + imd_quintile, family = binomial) -->

<!-- model_access <- glm(data = model_data, mental_accessed ~   schyear , family = binomial) -->

<!-- model_access <- glm(data = model_data, mental_accessed ~   sex , family = binomial) -->

<!-- summary(model_access) -->

<!-- df <- as.data.frame(exp(coef(model_access))) %>% -->

<!--   rename(Coefficient =  "exp(coef(model_access))") %>% -->

<!--   mutate(Group = rownames(.)) %>% -->

<!--   left_join(mutate(as.data.frame(exp(confint(model_access))), Group = row.names(.))) %>% -->
...
<!--   labs(title = "Accessing services having taken drugs ", -->
...
<!-- model_condition <- glm(data = model_data, condition_mental ~   schyear + sex + imd_quintile, family = binomial) -->

<!-- model_condition <- glm(data = model_data, condition_mental ~   schyear , family = binomial) -->

<!-- model_condition <- glm(data = model_data, condition_mental ~   sex , family = binomial) -->

<!-- model_condition <- glm(data = model_data, condition_mental ~   imd_quintile , family = binomial) -->

<!-- summary(model_condition) -->

<!-- df <- as.data.frame(exp(coef(model_condition))) %>% -->

<!--   rename(Coefficient =  "exp(coef(model_condition))") %>% -->

<!--   mutate(Group = rownames(.)) %>% -->

<!--   left_join(mutate(as.data.frame(exp(confint(model_condition))), Group = row.names(.))) %>% -->
