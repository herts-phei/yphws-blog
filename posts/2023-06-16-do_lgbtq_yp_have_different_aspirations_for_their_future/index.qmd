...
Here, we identify that a student's ssexual orientation has a very statistically significant relationship with continuing education, but with no statistical significance with any of the other pathways after school.
...
This is noteworthy in that it highlights differences
...
The crux of this analysis focuses on the sexual orientation of students, what is separate from that of biological sex. For the 2022 release of YPHWS, the survey refined the question on biological sex to one around gender identity, which expanded the number of options available, allowing students to tick non-binary and transgender as responses.
